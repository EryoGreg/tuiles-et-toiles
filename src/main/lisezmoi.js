...
const TEXTES = {
  ...
  racine: [
    ...
    'pack d\'œuvres.',
    '',
    'utilisateur.zip, historique/ (s\'ils existent)',
    '  Anciennes sauvegardes complètes (versions 0.2 et avant). L\'appli',
    '  ne les met plus à jour. Pour en reprendre une : télécharge-la, puis',
    '  Options → « Importer une sauvegarde… » (elle se fusionne avec tes',
    '  données, rien n\'est effacé). Supprimables sinon.',
    '',
    'journaux/',
  ...
  sauvegarde: [
    ...
    '« Exporter mes données »). Pour la reprendre : Options → « Importer',
    'une sauvegarde… ». Elle se FUSIONNE avec les données de l\'appareil :',
    'ce qui manque revient, rien n\'est effacé ; si une même tuile a changé',
    'des deux côtés, la version la plus récente est gardée et l\'autre',
    'proposée dans « Conflits ». Une copie de la base d\'avant est gardée.',
    '',
  ...
  rapports: [
    ...
    'Les rapports d\'erreur (Options → « Signaler un problème ») partent',
    'directement au développeur. Ce dossier n\'apparaît que si un envoi',
    'n\'a pas pu se faire (pas de connexion) : le rapport attend alors dans',
    'en-attente/ et repart tout seul au prochain lancement.'
  ],

  rapports_attente: [
    ...titre('Rapports en attente d\'envoi'),
    'Rapports d\'erreur qui n\'ont pas pu partir (pas de connexion au',
    'moment de l\'envoi). L\'application les renvoie automatiquement au',
    'prochain lancement, puis les supprime.',
    '',
    'Ils contiennent le journal de fonctionnement de l\'application, avec',
    'ton nom d\'utilisateur Windows, le nom de ton ordinateur et tes',
    'adresses email masqués. Tu peux les supprimer si tu ne veux plus',
    'les envoyer.'
  ],
